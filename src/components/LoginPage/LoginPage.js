...
const PhoneViewHide = styled.div`
  visibility: hidden;
  display: none;
      ...
      <>
        <PageLayout userName={null}
                    ...
                    <FlexBox margin="10px 25px 0px 25px" direction="column">
                      ...
                      <FlexBox  gap="15px">
                        <PhoneViewHide><FormButton google={true} onClick={userSignup}><FlexBox margin="0px 25px">Google sign up</FlexBox></FormButton></PhoneViewHide>
                        <FormButton colorButton={true} onClick={guestLogin}>Guest login</FormButton>
                        <PhoneViewHide><FormButton dark="true" onClick={explainAccounts}>What's the difference?</FormButton></PhoneViewHide>
                      </FlexBox>
